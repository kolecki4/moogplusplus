...
c     the ones found in an input line list
     ...
     .       wavelo, wavehi
      ...
      character*80 inlist, outlist, linepath, string, suffix
...
c*****read in file name suffix for this instance of Linemake
...
c*****open the unsorted output line list
      noutunit = 2
      open (noutunit,file='outlines'//suffix)
...
c*****wavelengths
      call system ('sort -bn -o outtemp'//suffix//' -k 1 outlines'//suffix)
      nunit = 7
      open (nunit,file='outtemp'//suffix)
      noutunit = 8
      open (noutunit,file='outsort'//suffix)
